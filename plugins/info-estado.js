...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Lexa 
  ${tradutor.texto1[2]} +56987507251
  ...
  const Message = {
    document: { url: `https://www.instagram.com/barbara_kimii/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/barbara_kimii/",
        mediaType: 2,
        previewType: "pdf",
        title: "Lexa ",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/barbara_kimii/",
      },
    },
    caption: info,
    footer: wm,
