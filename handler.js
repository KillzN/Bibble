...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/56987507251) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/KillzN/Bibble/master/src/avatar_contact.png';
          try {
